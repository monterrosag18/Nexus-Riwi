...
export default function renderLogin() {
  ...
  // ---------------------------------------------------------
  // Circuit PCB — trazas en esquinas, pocas líneas, estilo placa
  // ---------------------------------------------------------
  const generateCircuit = () => {
    ...
    // Dibuja una traza PCB con ángulos de 90° y nodo circular al final
    function drawTrace(points, animDelay, animDuration) {
      ...
      // Línea animada (fluye sobre la base)
      ...
      // Nodo pequeño relleno en el inicio
